...
public class Nim
{
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (player.getClass().equals(NaivePlayer.class)) {
                System.out.println(player + ": \""
                                   + ((NaivePlayer)player).makeComment()
                                   + "\"");
            }
            else if (player.getClass().equals(GreedyPlayer.class)) {
                System.out.println(player + ": \""
                                   + ((GreedyPlayer)player).makeComment()
                                   + "\"");
            }
